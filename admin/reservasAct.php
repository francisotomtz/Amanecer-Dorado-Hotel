...
<head>
    ...
    <title>Panel Administrador | Reservas activas</title>
</head>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9" id="content">
                <h2 class="mt-4">Reservas activas</h2>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                            include('php-bd/consultarRActivas.php');
                        ?>
                    </tbody>
                </table>
            </div>
    ...
    <script src="js/funcionesRActivas.js"></script>
